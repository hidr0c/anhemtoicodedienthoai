...
//        textChapter = findViewById(R.id.chapter_name);
        ...
        Call<ChapterImageRespone> imageCall = apiService.getChapterImageUrl(id);
        Call<ChapterDetailRespone> infoCall = apiService.getChapter(id, null);

        imageCall.enqueue(new Callback<ChapterImageRespone>() {
            @Override
            public void onResponse(@NonNull Call<ChapterImageRespone> call, @NonNull Response<ChapterImageRespone> response) {
                if (response.isSuccessful()) {
                    ChapterImageRespone res = response.body();
            ...
            @Override
            public void onFailure(@NonNull Call<ChapterImageRespone> call, Throwable t) {
                Toast.makeText(ReaderActivity.this, "Unable to fetch image", Toast.LENGTH_SHORT).show();
            }
        });
        infoCall.enqueue(new Callback<ChapterDetailRespone>() {
            @Override
            public void onResponse(@NonNull Call<ChapterDetailRespone> call, @NonNull Response<ChapterDetailRespone> response) {
                if (response.isSuccessful()) {
                    ChapterDetailRespone res = response.body();
                    toolbarReader.setSubtitle("Chapter " + res.data.attributes.chapter + " - " + res.data.attributes.title);
                }
            }

            @Override
            public void onFailure(@NonNull Call<ChapterDetailRespone> call, Throwable t) {
                Toast.makeText(ReaderActivity.this, "Unable to fetch image", Toast.LENGTH_SHORT).show();
            }
        });
